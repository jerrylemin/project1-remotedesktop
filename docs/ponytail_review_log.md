...
| Minimal refactor 2026-07-05 | `@ponytail-review` on agent config/providers/commands/remote files and deleted dead modules. | Diff, literal-reference search, focused tests, full suite. | Lean already. Direct imports replace wrappers; no new abstraction. Net source diff: -50 lines. | No. |
