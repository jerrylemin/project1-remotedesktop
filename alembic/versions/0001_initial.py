...
def downgrade() -> None:
    for table in ["enroll_tokens", "audit_events", "jobs", "sandbox_files", "artifacts", "session_participants", "control_sessions", "relay_nodes", "machine_grants", "machine_secrets", "machines", "user_roles", "roles", "users"]:
        op.drop_table(table)
